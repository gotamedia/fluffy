...
const LoadingTemplate: Story<Types.Component.Validation.Field.Loading> = (props) => {
...
Loading.args = {
    i18n: {
        text: "Loading validation message. Value: \"${value}\". FieldName: \"${fieldName}\". Label: \"${label}\"."
    }
}

export default {
    title: 'Developments/Components/FormSystem/Validation/Field',
    component: FS.Validation.Field.Loading,
    argTypes: { },
} as Meta<typeof FS.Validation.Field.Loading>
