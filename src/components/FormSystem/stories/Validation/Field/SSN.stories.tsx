...
const SSNTemplate: Story<Types.Component.Validation.Field.SSN> = (props) => {
...
export const SSN = SSNTemplate.bind({})
SSN.args = {}

export default {
    title: 'Developments/Components/FormSystem/Validation/Field',
    component: FS.Validation.Field.SSN,
    argTypes: { },
} as Meta<typeof FS.Validation.Field.SSN>
