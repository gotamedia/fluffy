...
describe("DateOrder", () => {
    describe("Functionality", () => {
        it("Should not crash", () => {
            cy.mount(
                <FS.Form i18n={{ fields: { input1: "Input1", input2: "Input2" }}}>
                    <FS.Validation.Form.DateOrder order={["input1", "input2"]} />
                    <FS.Field>
        ...
        it("Should validate", () => {
            ...
            cy.get(field2Selector).find(".react-datepicker .react-datepicker__day--008").click()
            cy.get(submitSelector).click()
        ...
        it("Should validate ignoring equal dates", () => {
            const onSubmitSpy = cy.spy().as('onSubmitSpy')
            ...
            cy.mount(
                <FS.Form
                    ...
                    onSubmit={onSubmit}
                >
                    <FS.Validation.Form.DateOrder order={["input1", "input2"]} ignoreEqualDates />
                    <FS.Field data-cy={"field1"}>
                        <FS.Input.DatePicker
                            name={"input1"}
                            data-cy={"input1"}
        ...
        it("Should trigger on change", () => {
            cy.mount(
                <FS.Form i18n={{ fields: { input1: "Input1", input2: "Input2" } }}>
                    <FS.Validation.Form.DateOrder order={["input1", "input2"]} validateOnChange />
                    <FS.Field data-cy={"field1"}>
                        <FS.Input.DatePicker
                            name={"input1"}
                            data-cy={"input1"}
